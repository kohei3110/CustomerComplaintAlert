...
class BlobStorageService:
    ...
    def get_blob_data(self, container_name, blob_name):
        try:
            ...
            print(f"Error getting blob data from container '{container_name}' and blob '{blob_name}': {e}")
    ...
    def get_sas_token(self, container_name, blob_name):
        try:
            ...
            print(f"Error generating SAS token for container '{container_name}' and blob '{blob_name}': {e}")
    ...
    def extract_complaint_details(self, container_name, blob_name):
        ...
        try:
            ...
            print(f"Error extracting complaint details from container '{container_name}' and blob '{blob_name}': {e}")
